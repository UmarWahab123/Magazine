                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('img/' . $setting->logo) }}" alt="alternative-text" width="50px"
                                        height="50px">
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('img/' . $setting->favicon) }}" alt="" width="50px"
                                        height="50px">
                                      @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-default"
                                        name="site_name" placeholder="Site Name" value="{{ old('site_name')?? $setting->site_name  }}">
                                </div>
                            </div>
                            <!--  -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control input-default"
                                        name="email" placeholder="Email" value="{{ old('email')?? $setting->email  }}">
                                </div>
                            </div>
                            <!--  -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-default"
                                        name="phone_no" placeholder="Phone" value="{{ old('phone_no')?? $setting->phone_no  }}">
                                </div>
                            </div>
                            <!--  -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-default"
                                        name="copyright" placeholder="Copyrights 2023 All Rights  Reserved." value="{{ old('copyright')?? $setting->copyright  }}">
                                </div>
                            </div>
